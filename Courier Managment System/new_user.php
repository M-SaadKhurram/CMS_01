...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $sql="INSERT INTO `users` ( `firstname`, `middlename`, `lastname`, `gender`, `phonenumber`, `email`, `street`, `city`, `state`, `country`, `username`, `password`, `role_id`) VALUES ( '$firstname', '$middlename', '$lastname', '$gender', '$phonenumber', '$email', '$street', '$city', '$state','$country', '$username', '$password', '3');";
...
<body>
    <div class="container mt-5">
        <h1 class="text-center">Creat New User</h1>
